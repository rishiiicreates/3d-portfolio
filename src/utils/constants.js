...
export const PLANET_CONFIG = {
  ...
  jupiter: {
    ...
    atmosphereColor: 0xB45309,
    hasRings: false,
    rotationSpeed: 0.002,
    moons: [
      { id: 'my-story', label: 'My Story', icon: '📖', orbitRadius: 75, orbitSpeed: 0.008, radius: 5 },
      { id: 'education', label: 'SRM × IIT-G', icon: '🎓', orbitRadius: 100, orbitSpeed: 0.006, radius: 5 },
      { id: 'philosophy', label: 'Philosophy', icon: '💭', orbitRadius: 125, orbitSpeed: 0.005, radius: 4 },
    ],
  },
  saturn: {
    name: 'Saturn',
    ...
    atmosphereColor: 0xEAB308,
    hasRings: true,
    ringColor: 0xFEF08A,
    rotationSpeed: 0.001,
    moons: [
      { id: 'blog-1', label: 'Latest Post', icon: '✍️', orbitRadius: 80, orbitSpeed: 0.01, radius: 4 },
      { id: 'blog-2', label: 'Thoughts', icon: '💡', orbitRadius: 100, orbitSpeed: 0.008, radius: 4 },
    ],
  },
  venus: {
    name: 'Venus',
